...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:contact@metadock.ai
      ?subject=Contact from ${form.name}
      &body=From: ${form.email}%0D%0A%0D%0A${form.message}`;
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-16">
          ...
          <p
            ...
            "
          >
            Interested in collaborations, research partnerships,
            or product inquiries? We’d love to hear from you.
          </p>
        </div>
